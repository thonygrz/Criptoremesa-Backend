...
ratesService.fullRates = async (req, res, next) => {
  try {
    ...
    let fullRateFromAPI = (await axios.get(`https://api.currencyfreaks.com/latest?apikey=${env.CURRENCY_FREAKS_API}&symbols=${currentManualRate.currency_origin_iso_code}`)).data;
