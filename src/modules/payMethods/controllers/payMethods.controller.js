...
payMethodsController.getPayMethodsByCountryAndCurrency = async (req, res, next) => {
  try {
    ...
    if (!req.isAuthenticated() && env.ENVIROMENT === ENVIROMENTS.PRODUCTION){
      ...
      let finalResp = await payMethodsService.getPayMethodsByCountryAndCurrency(req, res, next);
...
payMethodsController.depositMethodsByBank = async (req, res, next) => {
  try {
    ...
    if (!req.isAuthenticated() && env.ENVIROMENT === ENVIROMENTS.PRODUCTION){
      ...
      let finalResp = await payMethodsService.depositMethodsByBank(req, res, next);
